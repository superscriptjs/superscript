...
exports.encodeCommas = function(str) {
  if (str) {
...
exports.decodeCommas = function(str) {
  if (str) {
...
exports.trim = function (text) {
  ...
  if (before !== text) {
    debug.verbose("Trim", before, text);
  }
  return text;
};
...
var walk = function (dir, done) {
  ...
  if (fs.statSync(dir).isFile()) {
    debug.verbose("Expected directory, found file, simulating directory with only one file: " + dir);
