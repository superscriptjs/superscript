...
exports.parse = function (regexp, facts, callback) {
  ...
  regexp = regexp.replace(/\*([0-9]{1,2})/g, replacer1);  // Convert *n into multi word EXACT match
  regexp = regexp.replace(/\*(~[0-9]{1,2}\s?)/g, replacer2);  // Convert *~n into multi word VARIABLE match
