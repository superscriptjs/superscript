      ...
      switch (cmd) {
        ...
        case "+":
          ...
          regexreply.parse(line, factSystem, function (regexp) {
            ...
            var gambit = _initGambitTree(topicName, idTrigger, regexp, line, trigOptions);
            if (_.size(gambit) > 0) {
              currentTrigger = idTrigger;
        ...
        case ">":
          ...
          if (KEYWORD_RE.test(line)) {
            ...
            keywords = keywords.filter(function (x) {
              return x;
            });
            line = line.replace(m[1], "");
          }
        ...
        case "*":
          ...
          idTrigger = Utils.genId();
          var gambit = _initGambitTree(topicName, idTrigger, line, null, options, "botTopics");
          if (_.size(gambit) > 0) {
            gambits = _.extend(gambits, gambit);
          }
          nextInstruction();
