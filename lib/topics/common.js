            ...
            if (trigger.isQuestion && message.isQuestion) {
                ...
                if (trigger.isDisordered === true) {
                    ...
                    if (intersection.length > 0) {
                        ...
                        var isStars, starPattern, starPatternClean;
                        ...
                        if (isStars) {
                            ...
                            // объединяем все найденные данные в сообщениt и в правило
                            ...
                            if (matchedStarsArray) match[1] = matchedStarsArray.join(' ');
                        }
                        if (isStars && !matchedStarsArray) {
                            match = null;
                        } else {
                            match[0] = message.clean;
