        ...
        var eachGambitItor = function(gambitId, next2) {
          ...
          topic.createGambit(gambitData, function(err, gambit){
            ...
            var replyItor = function(replyId, cb) {
              ...
              var replyString = gambitData.reply[replyId];
              var properties = { id: replyId, reply: gambitData.reply[replyId] };
            ...
            console.log(gambitData)
            async.each(Object.keys(gambitData.reply), replyItor, function(err, res){
