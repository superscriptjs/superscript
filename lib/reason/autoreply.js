...
module.exports = function(message, user, facts, cnet, cb) {
  ...
  if (message.isQuestion) {
    ...
    switch (course) {
      case "NUM":   suggestedReply = numReply(message, facts, cnet, user, cb); break;
      case "HUM":   suggestedReply = humReply(message, facts, cnet, user, cb); break;
      case "DESC":  suggestedReply = descReply(message, facts, cnet, user, cb); break;
      case "ENTY":  suggestedReply = entyReply(message, facts, cnet, user, cb); break;
      case "LOC":   suggestedReply = locReply(message, facts, cnet, user, cb); break;
      case "ABBR":  suggestedReply = abbrReply(message, facts, cnet, user, cb); break;
      default: 
